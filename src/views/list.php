...
<main class="container d-flex justify-content-center mt-5">
    <div class="w-50 shadow rounded bg-white p-2">
        <table class="table table-responsive bg-none mt-3 p-4">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="submit" class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#modal_<?= htmlspecialchars($row['id']) ?>" style="background-color: #9C86FF;"><i class="bi bi-pencil-square text-white"></i></button>
